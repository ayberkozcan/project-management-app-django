...
urlpatterns = [
    ...
    path("<int:group_id>/comments/", GroupCommentListView.as_view(), name="group_comments"),
    path("<int:group_id>/comments/<int:comment_id>/delete/", delete_group_comment, name="group_comment_delete"),
